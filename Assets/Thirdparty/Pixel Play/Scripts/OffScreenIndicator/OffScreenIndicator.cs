...
public class OffScreenIndicator : MonoBehaviour
{
    ...
    void DrawIndicators()
    {
        foreach(Target target in targets)
        {
            ...
            float distanceFromPlayer = target.NeedDistanceText ? target.GetDistanceFromPlayer(player.position) : float.MinValue;// Gets the target distance from the camera.
            ...
            if(indicator)
            {
                ...
                indicator.SetDistanceText(distanceFromPlayer); //Set the distance text for the indicator.
